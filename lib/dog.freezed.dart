...
class _$DogTearOff {
  ...
  _Dog call({required String id, required String name, required String image}) {
    return _Dog(
      id: id,
      name: name,
      image: image,
...
class _$_Dog implements _Dog {
  _$_Dog({required this.id, required this.name, required this.image});
  ...
  @override
  String toString() {
    return 'Dog(id: $id, name: $name, image: $image)';
  }
