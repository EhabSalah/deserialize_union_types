...
class _$CatTearOff {
  ...
  _Cat call({required String id, required String name}) {
    return _Cat(
      id: id,
      name: name,
    );
...
class _$_Cat implements _Cat {
  _$_Cat({required this.id, required this.name});
...
abstract class _Cat implements Cat {
  factory _Cat({required String id, required String name}) = _$_Cat;
